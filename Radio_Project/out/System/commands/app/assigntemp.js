...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var interactionUser, otheruserid, userId, channelID, x;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (DS_1.CommunityData[2][0].indexOf(userId) <= -1) {
                            ...
                            (0, Net_1.Send_Embeded)((0, Discord_Emb_1.Emb_GeneralNotice)("Assigned User to your temp radio channel", userId), channelID);
                            (0, Net_1.Assign_RadioUserChannel)(otheruserid, DS_1.CommunityData[2][1][x][0]);
                        }
