...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var interactionUser, userId, ch_name, job_name, channelID, emb, emb;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        job_name = interaction.options.get("job").value;
                        channelID = interaction.channelId;
                        if (DS_1.CommunityData[1][0].indexOf(userId) >= 0 || String(userId).includes("662529839332327424")) {
                            emb = (0, Discord_Emb_1.Emb_NewChannel)(String((0, Net_1.MakeChannel)(ch_name, job_name)), ch_name);
